namespace DanTup.DartVS.ProjectSystem.PropertyPages
{
    ...
    public partial class DartBuildPropertyPagePanel : DartPropertyPagePanel
    {
        public DartBuildPropertyPagePanel()
            : this(null)
        {
        }

        public DartBuildPropertyPagePanel(DartPropertyPage parentPropertyPage)
        ...
        public new DartBuildPropertyPage ParentPropertyPage
        {
            get
            {
                return base.ParentPropertyPage as DartBuildPropertyPage;
            }
        }
