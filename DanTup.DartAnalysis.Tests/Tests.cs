namespace DanTup.DartAnalysis.Tests
{
	public abstract class Tests
	{
		...
		protected const string ServerScript = @"M:\Coding\Applications\Dart\dart\pkg\analysis_server\bin\server.dart";
		protected const string SampleDartProject = @"M:\Coding\TestApps\DartServerTest\SampleDartProject";
